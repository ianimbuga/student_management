...
#         list_students()
#     elif choice == "3":
#         update_student()  # New option to update student
#     elif choice == "4":
#         delete_student()  # New option to delete student
#     elif choice == "5":
#         create_course()
#     elif choice == "6":
#         list_courses()
...
def main_menu():
    ...
    if choice == "1":
        ...
        update_student()  # Update student functionality
    elif choice == "4":
        delete_student()  # Delete student functionality
    elif choice == "5":
        create_course()
    elif choice == "6":
        list_courses()
    elif choice == "7":
        update_course()  # Update course functionality
    elif choice == "8":
        delete_course()  # Delete course functionality
    elif choice == "9":
        create_enrollment()
    elif choice == "0":
        sys.exit()
